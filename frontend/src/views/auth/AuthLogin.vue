            ...
            <div class="minimal-card-wrapper">
                <div class="card mb-4 mt-5 mx-4 mx-sm-0 position-relative">
                    <div class="wd-50 bg-white p-2 rounded-circle shadow-lg position-absolute translate-middle top-0 start-50">
                        <img src="/private/images/logo-abbr.png" alt="" class="img-fluid">
                    </div>
                    <div class="card-body p-sm-5">
                        ...
                        <form @submit.prevent="login" class="w-100 mt-4 pt-2">
                            <div class="mb-4">
                                <input v-model="username" type="text" class="form-control" placeholder="Usuario" value="" required>
                            </div>
                            <div class="mb-3">
                                <input v-model="password" type="password" class="form-control" placeholder="Contraseña" value="" required>
                            </div>
                        ...
                        <div class="mt-5 text-muted">
                            ...
                            <router-link to="/auth/register" class="fw-bold">Create an Account</router-link>
                        </div>
                    </div>
                </div>
            </div>
